...
class InventoryVisualizer:
    ...
    def plot_daily_performance(self, save_path: str = "plots/daily_performance.png"):
        ...
        if best_ss and best_rl:
            ...
            axes[0, 0].plot(best_rl['daily_costs'], label='PPO Agent', alpha=0.7, linewidth=2)
            ...
            axes[0, 1].plot(best_rl['daily_shortages'], label='PPO Agent', alpha=0.7, linewidth=2)
            ...
            axes[1, 0].plot(best_rl['daily_orders'], label='PPO Agent', alpha=0.7, linewidth=2)
    ...
    def plot_summary_dashboard(self, save_path: str = "plots/summary_dashboard.png"):
        ...
        if 'best_ss' in self.results and 'best_rl' in self.results and self.results['best_rl']:
            ...
            ax5.plot(best_rl['daily_costs'], label='PPO Agent', alpha=0.7)
            ...
            ax6.plot(best_rl['daily_shortages'], label='PPO Agent', alpha=0.7)
    ...
    def plot_per_product_daily_performance(self, save_path: str = "plots/per_product_daily_performance.png"):
        ...
        if best_ss and best_rl:
            ...
            axes[0, 0].plot(best_rl['daily_costs_product1'], label='PPO Agent', alpha=0.7, linewidth=2)
            ...
            axes[0, 1].plot(best_rl['daily_costs_product2'], label='PPO Agent', alpha=0.7, linewidth=2)
            ...
            axes[1, 0].plot(best_rl['daily_shortages_product1'], label='PPO Agent', alpha=0.7, linewidth=2)
            ...
            axes[1, 1].plot(best_rl['daily_shortages_product2'], label='PPO Agent', alpha=0.7, linewidth=2)
